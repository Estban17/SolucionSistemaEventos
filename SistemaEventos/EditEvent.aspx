            ...
            <div id="page-content-wrapper" class="p-4 mt-4">
                ...
                <div class="container">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="txtDescripcion" ErrorMessage="La descripción es obligatoria" CssClass="text-danger" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvNumAsistentes" runat="server" ControlToValidate="txtNumAsistentes" ErrorMessage="El número de asistentes es obligatorio" CssClass="text-danger" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvFechaInicio" runat="server" ControlToValidate="txtFechaInicio" ErrorMessage="La fecha de inicio es obligatoria" CssClass="text-danger" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvFechaFin" runat="server" ControlToValidate="txtFechaFin" ErrorMessage="La fecha de fin es obligatoria" CssClass="text-danger" />
                    </div>
                    ...
                    <asp:Button ID="btnEditEvento" runat="server" Text="Guardar Cambios" CssClass="btn btn-primary" OnClick="btnEditEvento_Click" />
